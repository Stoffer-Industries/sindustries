...
case "$MODE" in
  dev)
    ...
    export CONTENT_SCHEDULER_API_PORT="4003"
    ...
    export CONTENT_SCHEDULER_API_BASE_URL="http://localhost:${CONTENT_SCHEDULER_API_PORT}/api/v1"
  ...
  prodlike)
    ...
    export CONTENT_SCHEDULER_API_PORT="4004"
