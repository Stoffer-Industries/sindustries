...
flowchart TD
  ...
  resolve_topic_approval["resolve_topic_approval\nrun: lobster_resolve_topic_approval.py"]
  ...
  create_tasks_from_proposals -->|stdin| resolve_topic_approval
  request_spec_approval -->|when: approved| resolve_topic_approval
```
