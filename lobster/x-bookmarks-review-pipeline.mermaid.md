...
flowchart TD
  ...
  filter_curation["filter_curation\nrun: python3 codebases/sindustries/agents/workflows/bookmark/filter_curation.py …"]
  ...
  summarize -->|next| filter_curation
  summarize -->|stdin| filter_curation
  filter_curation -->|next| generate_specs
  filter_curation -->|stdin| generate_specs
