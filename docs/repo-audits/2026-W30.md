...
**3-A. Document the in-process adapter's failure mode in `docs/systems/content-scheduler-auto-post.md`** ✅ [PR #TBD](https://github.com/Stoffer-Industries/sindustries/pull/TBD)
- *Effort:* S
- *Follow-up classification:* `garden-safe`.
