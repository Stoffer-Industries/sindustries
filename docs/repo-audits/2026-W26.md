...
**[Medium] `routes/tasks.ts` is 517 lines mixing validation, query building, sorting, and mapping** *(persists)* ✅ [PR #TBD](https://github.com/Stoffer-Industries/sindustries/pull/TBD)
