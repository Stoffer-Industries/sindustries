...
- Agent ops: `agents/skills/` (bookmark curation, spec authoring, content authoring, repo-audit); `agents/crons/prompts/` (cron definitions); `agents/workflows/bookmarks/` (lobster pipeline scripts)
