...
**[Medium] No system-spec callout for the spec-checksum drift handshake's interaction with PATCH writes** ✅ [PR #TBD](https://github.com/Stoffer-Industries/sindustries/pull/TBD)
...
| 3-J | Document the spec-checksum mismatch contract in `docs/systems/feature-task-workflow.md` ✅ [PR #TBD](https://github.com/Stoffer-Industries/sindustries/pull/TBD) | S |
