...
- **Q2 — Fix mission-control `@types/react`/`@types/react-dom` pins.** Downgrade to `^18.x` matching the runtime. S / low risk. (Theme 2, ties M6.) ✅ [PR #TBD](https://github.com/Stoffer-Industries/sindustries/pull/TBD)
