...
//
// The legacy task-description `Approved by Tom` approval checkbox (a
// `- [x]` line of markdown followed by `**Approved by Tom**`) is no longer
// preserved, auto-unchecked, or rewritten by this surface (per task
// `e2aba106-e1f6-4faf-ad81-3e5bec1b4574`). Approval state is structured
