...
class ModuleSurfaceTests(unittest.TestCase):
    ...
    def test_module_default_constant_is_forty_five_seconds(self) -> None:
        # The default is 45s for heavyweight cron tasks such as the W37 feature-task
        # carve. The earlier 25s default was too tight and caused the lobster's inner
        # subprocess to abort before the task could finish.
        self.assertEqual(DEFAULT_TIMEOUT_SECONDS, 45.0)
...
class SafePopenTests(unittest.TestCase):
    ...
    def test_b_prime_default_constant_also_fires_within_window(self) -> None:
        # Sanity: with the module's DEFAULT_TIMEOUT_SECONDS = 45, an explicit
