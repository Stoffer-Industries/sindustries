...
1. When `/workouts` finds no active OAuth consent, it shows **Connect to your agent** with an explicit Claude option, the remote MCP URL, and the seeded public client ID.
