...
/**
 * Normalize history entries to array format
 * @param {unknown} history
 * @returns {Array<{id?: string|number, field: string, oldValue?: string|null, newValue?: string|null, actor?: string|null, createdAt?: string}>}
 */
